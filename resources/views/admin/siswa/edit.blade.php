                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="nama_lengkap" id="nama_lengkap" value="{{ old('nama_lengkap', $siswa->nama_lengkap) }}"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="nomor_telepon" id="nomor_telepon" value="{{ old('nomor_telepon', $siswa->nomor_telepon) }}"
                            ...
                            <div>
                                <div class="mb-4">
                                    ...
                                    <input type="date" name="tanggal_bergabung" id="tanggal_bergabung" value="{{ old('tanggal_bergabung', $siswa->tanggal_bergabung->format('Y-m-d')) }}"
                                        class="mt-1 block w-full border-gray-300 focus:border-terakota focus:ring-terakota rounded-md shadow-sm" required>
                                </div>
                                <div class="mb-4">
